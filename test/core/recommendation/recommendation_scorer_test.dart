...
void main() {
  ...
  test(
    'a track from a high-affinity artist scores higher than a neutral one',
    () {
      ...
      final neutralScore = scorer.score(
        track,
        neutralProfile,
        sourceQuery: null,
        isTrendingOrNewSource: false,
  ...
  test('trending/new-content source gets a popularity boost', () {
    ...
    final trending = scorer.score(
      track,
      profile,
      sourceQuery: null,
      isTrendingOrNewSource: true,
    );
    final nonTrending = scorer.score(
      track,
      profile,
      sourceQuery: null,
      isTrendingOrNewSource: false,
  ...
  test(
    ...
    () async {
      ...
      expect(
        result.debugBreakdown!['completionProbability'],
        closeTo(2 / 3, 0.01),
      );
    },
  );
