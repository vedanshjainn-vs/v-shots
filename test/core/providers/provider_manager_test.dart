...
void main() {
  ...
  group('ProviderManager', () {
    ...
    test(
      'default config routes InnerTube first, YouTube as fallback',
      () async {
    ...
    test('InnerTube failure falls through to the YouTube provider', () async {
