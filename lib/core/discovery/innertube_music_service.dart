...
const Map<String, List<String>> kMoodQueries = {
  ...
  'Romantic': ['romantic love songs', 'romantic hindi songs'],
  'Sad': ['sad heartbreak songs', 'emotional songs'],
  'Heartbreak': ['sad heartbreak songs', 'breakup songs'],
  ...
  'Peaceful': ['peaceful calm instrumental', 'zen meditation music'],
  'Late Night': ['late night lofi', 'night chill songs'],
  'Road Trip': ['road trip driving songs', 'highway travel music'],
  'Happy': ['happy feel good songs', 'upbeat cheerful songs'],
  'Attitude': ['attitude power songs', 'confident hip hop'],
  'Rainy': ['rainy day songs', 'monsoon romantic songs'],
  'Nostalgic': ['90s nostalgia songs', 'old hindi classics'],
  ...
  'Rock': ['rock songs hits', 'classic rock songs'],
};
