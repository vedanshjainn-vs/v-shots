...
if __name__ == '__main__':
    ...
    runpy.run_path('scripts/apply_home_discovery_import_cleanup.py', run_name='__main__')
    runpy.run_path('scripts/apply_home_discovery_last_guard.py', run_name='__main__')
